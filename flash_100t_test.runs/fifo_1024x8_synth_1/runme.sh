...
HD_PWD='D:/2024/01/Upgrade_online/flash_100t_test/flash_100t_test.runs/fifo_1024x8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_1024x8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_1024x8.tcl
