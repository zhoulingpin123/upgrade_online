...
#
# Generated by export_simulation on Wed Jan 10 11:19:44 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './fifo_1024x8.sh' script.

./fifo_1024x8.sh -reset_run
...
./fifo_1024x8.sh -noclean_files

For more information on the script, please type './fifo_1024x8.sh -help'.
